...
class TestInvest(unittest.TestCase):
    def carbon_model_regression_test(self):
        ...
        assert_raster_equality(output_dictionary['output'], '../../test_data/carbon_regression.tif' )
        pass




        def verify_carbon3_against_carbon21_int_pools(self):
            ...
            assert_raster_equality(output_dictionary['output'], '../../test_data/tot_c_cur_int')
            pass
