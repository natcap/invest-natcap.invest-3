    ...
    class CustomPy2exe(py2exeCommand):
        ...
        def create_binaries(self, py_files, extensions, dlls):
            ...
            self.distribution.data_files += [
                ...
                ('invest_natcap/scenario_generatorjschart/jquery/js/',
                    ['invest_natcap/scenario_generator/jschart/jquery/js/jquery-1.6.2.min.js']),
                ('invest_natcap/scenario_generator/jschart/highcharts/js/',
                     ['invest_natcap/scenario_generator/jschart/highcharts/js/highcharts.js']),
