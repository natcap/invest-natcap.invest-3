...
#define PACKAGE_STRING "PostgreSQL 8.3.10"

/* Define to the version of this package. */
#define PACKAGE_VERSION "8.3.10"

/* PostgreSQL version as a string */
#define PG_VERSION "8.3.10"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 80310
...
#define PG_VERSION_STR "PostgreSQL 8.3.10, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER)
...
#define ENABLE_GSS 1
#define VAL_CONFIGURE "--enable-thread-safety --enable-nls --with-ldap --with-ossp-uuid --with-libxml --with-libxslt --with-krb5 --with-tcl --with-perl --with-python"
