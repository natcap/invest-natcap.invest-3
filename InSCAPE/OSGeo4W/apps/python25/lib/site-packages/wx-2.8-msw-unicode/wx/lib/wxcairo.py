...
#
# Created:     3-Sept-2008
# RCS-ID:      $Id: wxcairo.py 55808 2008-09-22 21:54:53Z RD $
...
# convert a C pointer value to pycairo objects.  The information on
# the API structure is gleaned from pycairo.h. 
