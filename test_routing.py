...
def main():
    #dem_uri = r"C:\Users\rpsharp\Dropbox_stanford\Dropbox\brian_packard_dem_nutrient_bug\dem"
    dem_uri = r"C:\Users\rpsharp\Documents\invest-natcap.invest-3\test\invest-data\Base_Data\Freshwater\dem"
    ...
    subprocess.Popen([qgis_bin, flow_accumulation_uri], cwd=os.path.dirname(qgis_bin))
