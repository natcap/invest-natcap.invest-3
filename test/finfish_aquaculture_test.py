...
class TestFinfishAquaculture(unittest.TestCase):
    def get_args(self):
        ...
        args['reg_cy_hist'] = {1: [(1, 3, 6266.532049655182), 
        ...
        args['tpw_totals'] =  {1: 19170334.68056063, 4: 45996057.19164784}
        args['indiv_cy_tpw'] = {1: [3195055.7800934385, 3195055.7800934385, 
        ...
        args['reg_value_hist'] =  {1: [(5032212.853647165, 5029315.411732361), 
        ...
        args['reg_npv'] = {1: 25520.257952021995, 4: 63041.293554722826}
        return args
    ...
    def test_format_temp_table(self):
        reg_temp_table = _get_reg_temp_table()
        args = self.get_args()
    ...
    def TODO_FIX_finfish_aquaculture(self):
