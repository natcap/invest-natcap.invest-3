...
#            for x in active_pixels_dataset[a, 2, add, :]:   
            for i in range(active_pixels_dataset[a, add].size/3):
                row =  active_pixels_dataset[a, add, i*3]
                col =  active_pixels_dataset[a, add, i*3+1]
                x = active_pixels_dataset[a, add, i*3+2]
                if x != -1:
...
#            sys.exit(0)
            ...
            non_mem_efficient_angles = \
                np.sort(add_events[non_mem_efficient_ids])
