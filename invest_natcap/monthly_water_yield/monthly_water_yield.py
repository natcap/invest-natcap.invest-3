...
def calculate_alphas(slope_uri, sandy, smax_uri, alpha_table):
    """Calculates and creates gdal datasets for three alpha values used in
        ...
        alpha_table - a dictionary for the constant coefficients used in
            ...
            alpha_table = {'alpha_one':{'a_one':5, 'b_one':2, 'b_three':1},
    ...
    raster_utils.vectorize_datasets(
            [smax_uri], alpha_two_op, alpha_two_uri, gdal.GDT_Float32,
            float_nodata, dem_cell_size, 'intersection')
    
    raster_utils.vectorize_datasets(
            [smax_uri], alpha_three_op, alpha_three_uri, gdal.GDT_Float32,
            float_nodata, dem_cell_size, 'intersection')
