...
def execute(args):
    ...
    raster_out_gt = raster_utils.get_geotransform_uri(raster_out_uri)
    ...
    adv_v_memory_mapped_uri = raster_utils.temporary_filename()
    adv_v_array = raster_utils.load_memory_mapped_array(
    ...
    raster_utils.calculate_raster_stats_uri(raster_out_uri)
