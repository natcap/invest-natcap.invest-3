...
#        #of analysis_area
    ...
    clipped_wave_shape = \
        shp_driver.CopyDataSource(args['analysis_area'], clipped_wave_shape_path)
...
#    clipped_wave_layer = args['analysis_area'].GetLayer(0)
...
def compute_wave_energy_capacity(wave_data, interp_z, machine_param):
    ...
    for key, val in wave_data['bin_matrix'].iteritems():
        ...
        #Divide the matrix by 7 to get the yearly values
        valid_array = np.divide(mult_matrix, 7.0)
