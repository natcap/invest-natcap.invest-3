...
def sum_by_category_uri(category_uri, value_uri, categories=None):
    ...
    if categories is None:
        categories = raster_utils.unique_raster_values_count(
            category_uri).keys()
...
def execute(args):
    ...
    :param args["workspace_dir"]: The directory to hold output from a
    ...
    if "carbon_schedule" in args:
        carbon_schedule_csv = raster_utils.get_lookup_from_csv(
