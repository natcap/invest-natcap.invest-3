...
def execute(args):
    ...
    LOGGER.info(' `--.  ,---'|   |  ( ' ) /   '  \  \|  ,  \ |  || (`' ) /     (`' )/`--'        | ( ' )  |  / `-' \  | ,_/  \__) |   |  ( ' )          |   |  ')
    LOGGER.info('   |   \   |   '-(_{;}_)|___|  /  ||  |\_ \|  ||(_ ()_)     (_ o _).           |(_ o _) /   `-'`"`,-./  )       |   '-(_{;}_)          \ /   ')
    LOGGER.info('    :_ _:   |      (_,_)    _.-`   ||  _( )_\  || (_,_)   __  (_,_). '.         | (_,_).' __ .---. \  '_ '`)     |      (_,_)            v    ')
    LOGGER.info('    (_I_)   | _ _--.   | .'   _    || (_ o _)  ||  |\ \  |  |.---.  \  :        |  |\ \  |  ||   |  > (_)  )  __ | _ _--.   |           _ _   ')
    LOGGER.info('   (_(=)_)  |( ' ) |   | |  _( )_  ||  (_,_)\  ||  | \ `'   /\    `-'  |        |  | \ `'   /|   | (  .  .-'_/  )|( ' ) |   |          (_I_)  ')
    LOGGER.info('    (_I_)   (_{;}_)|   | \ (_ o _) /|  |    |  ||  |  \    /  \       /         |  |  \    / |   |  `-'`-'     / (_{;}_)|   |         (_(=)_) ')
    LOGGER.info('    '---'   '(_,_) '---'  '.(_,_).' '--'    '--'`--'   `'-'    `-...-'          ''-'   `'-'  '---'    `._____.'  '(_,_) '---'          (_I_)  ')
