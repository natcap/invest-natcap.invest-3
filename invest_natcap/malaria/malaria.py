...
def execute_30(**args):
	...
	wyield_uri - a uri to a gdal dataset specifying per pixel water yield
	max_vector_flight -- a floating point number specifying the flight distance of
		a vector from a breeding site
